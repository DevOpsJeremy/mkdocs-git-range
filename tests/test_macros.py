...
class TestMacroIntegration:
    ...
    def test_macro_closure_captures_plugin_state(self):
        ...
        # Test that changing plugin state doesn't affect the captured macro
        plugin.include = ['different_file.md']
        result2 = macro()
        assert result2 == ['captured_file.md']  # Should still be the original
